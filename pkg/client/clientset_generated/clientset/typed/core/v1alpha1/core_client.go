...
import (
	...
	"github.com/hawq-cn/apiserver-example/pkg/client/clientset_generated/clientset/scheme"
...
// CoreV1alpha1Client is used to interact with features provided by the core.hawq.org group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) MyResources(namespace string) MyResourceInterface {
